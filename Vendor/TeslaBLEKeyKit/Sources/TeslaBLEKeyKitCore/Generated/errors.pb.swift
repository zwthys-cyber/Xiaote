...
public enum Errors_GenericError_E: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Errors_GenericError_E] = [
    .genericerrorNone,
    .genericerrorUnknown,
...
public struct Errors_NominalError: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var genericError: Errors_GenericError_E = .genericerrorNone
...
extension Errors_NominalError: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NominalError"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}genericError\0")
  ...
  public static func ==(lhs: Errors_NominalError, rhs: Errors_NominalError) -> Bool {
