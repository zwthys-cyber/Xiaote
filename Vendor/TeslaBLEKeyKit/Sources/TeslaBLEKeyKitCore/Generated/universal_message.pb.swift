...
public enum UniversalMessage_Domain: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [UniversalMessage_Domain] = [
    .broadcast,
    .vehicleSecurity,
    .infotainment,
  ]
...
public enum UniversalMessage_OperationStatus_E: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [UniversalMessage_OperationStatus_E] = [
    .operationstatusOk,
    .operationstatusWait,
    .rror,
  ]
...
public enum UniversalMessage_MessageFault_E: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [UniversalMessage_MessageFault_E] = [
    .rrorNone,
    .rrorBusy,
    .rrorTimeout,
    .rrorUnknownKeyID,
...
public enum UniversalMessage_Flags: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [UniversalMessage_Flags] = [
    .flagUserCommand,
    .flagEncryptResponse,
  ]
...
public struct UniversalMessage_Destination: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var subDestination: UniversalMessage_Destination.OneOf_SubDestination? = nil

  public var domain: UniversalMessage_Domain {
    get {
  ...
  public var routingAddress: Data {
    get {
  ...
  public enum OneOf_SubDestination: Equatable, Sendable {
...
public struct UniversalMessage_MessageStatus: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var operationStatus: UniversalMessage_OperationStatus_E = .operationstatusOk

  public var signedMessageFault: UniversalMessage_MessageFault_E = .rrorNone
...
public struct UniversalMessage_SessionInfoRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct UniversalMessage_RoutableMessage: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var toDestination: UniversalMessage_Destination {
  ...
  public var hasToDestination: Bool {self._toDestination != nil}
  /// Clears the value of `toDestination`. Subsequent reads from it will return its default value.
  public mutating func clearToDestination() {self._toDestination = nil}

  public var fromDestination: UniversalMessage_Destination {
  ...
  public var hasFromDestination: Bool {self._fromDestination != nil}
  /// Clears the value of `fromDestination`. Subsequent reads from it will return its default value.
  public mutating func clearFromDestination() {self._fromDestination = nil}

  public var payload: UniversalMessage_RoutableMessage.OneOf_Payload? = nil

  public var protobufMessageAsBytes: Data {
    get {
  ...
  public var sessionInfoRequest: UniversalMessage_SessionInfoRequest {
    get {
  ...
  public var subSigData: UniversalMessage_RoutableMessage.OneOf_SubSigData? = nil

  public var signatureData: Signatures_SignatureData {
    get {
  ...
  public var signedMessageStatus: UniversalMessage_MessageStatus {
  ...
  public var hasSignedMessageStatus: Bool {self._signedMessageStatus != nil}
  /// Clears the value of `signedMessageStatus`. Subsequent reads from it will return its default value.
  public mutating func clearSignedMessageStatus() {self._signedMessageStatus = nil}

  public var requestUuid: Data = Data()
  ...
  public enum OneOf_SubSigData: Equatable, Sendable {
...
extension UniversalMessage_Domain: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0DOMAIN_BROADCAST\0\u{2}\u{2}DOMAIN_VEHICLE_SECURITY\0\u{1}DOMAIN_INFOTAINMENT\0")
}
...
extension UniversalMessage_Flags: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0FLAG_USER_COMMAND\0\u{1}FLAG_ENCRYPT_RESPONSE\0")
}
...
extension UniversalMessage_Destination: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}domain\0\u{3}routing_address\0")
  ...
  public static func ==(lhs: UniversalMessage_Destination, rhs: UniversalMessage_Destination) -> Bool {
...
extension UniversalMessage_MessageStatus: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}operation_status\0\u{3}signed_message_fault\0")
  ...
  public static func ==(lhs: UniversalMessage_MessageStatus, rhs: UniversalMessage_MessageStatus) -> Bool {
...
extension UniversalMessage_SessionInfoRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SessionInfoRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}public_key\0\u{1}challenge\0")
  ...
  public static func ==(lhs: UniversalMessage_SessionInfoRequest, rhs: UniversalMessage_SessionInfoRequest) -> Bool {
...
extension UniversalMessage_RoutableMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RoutableMessage"
  ...
  public static func ==(lhs: UniversalMessage_RoutableMessage, rhs: UniversalMessage_RoutableMessage) -> Bool {
