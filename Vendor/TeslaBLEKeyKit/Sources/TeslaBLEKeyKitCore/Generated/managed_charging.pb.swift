...
public enum ManagedCharging_ChargeOnSolarNoChargeReason: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [ManagedCharging_ChargeOnSolarNoChargeReason] = [
    .invalid,
