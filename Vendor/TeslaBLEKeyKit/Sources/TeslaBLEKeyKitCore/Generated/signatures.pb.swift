...
public enum Signatures_Tag: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [Signatures_Tag] = [
    .signatureType,
    .domain,
    .personalization,
    .epoch,
...
public enum Signatures_SignatureType: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case aesGcm // = 0
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Signatures_SignatureType] = [
    .aesGcm,
    .aesGcmPersonalized,
    .hmac,
    .hmacPersonalized,
...
public enum Signatures_Session_Info_Status: SwiftProtobuf.Enum, Swift.CaseIterable {
  public typealias RawValue = Int
  case ok // = 0
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Signatures_Session_Info_Status] = [
    .ok,
    .keyNotOnWhitelist,
  ]
...
public struct Signatures_KeyIdentity: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var identityType: Signatures_KeyIdentity.OneOf_IdentityType? = nil
  ...
  public enum OneOf_IdentityType: Equatable, Sendable {
    case publicKey(Data)
    case handle(UInt32)
...
public struct Signatures_AES_GCM_Personalized_Signature_Data: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var epoch: Data = Data()
...
public struct Signatures_AES_GCM_Response_Signature_Data: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Signatures_HMAC_Signature_Data: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Signatures_HMAC_Personalized_Signature_Data: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Signatures_SignatureData: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var signerIdentity: Signatures_KeyIdentity {
  ...
  public var hasSignerIdentity: Bool {self._signerIdentity != nil}
  /// Clears the value of `signerIdentity`. Subsequent reads from it will return its default value.
  public mutating func clearSignerIdentity() {self._signerIdentity = nil}

  public var sigType: Signatures_SignatureData.OneOf_SigType? = nil

  public var aesGcmPersonalizedData: Signatures_AES_GCM_Personalized_Signature_Data {
    get {
  ...
  public var sessionInfoTag: Signatures_HMAC_Signature_Data {
    get {
  ...
  public var hmacPersonalizedData: Signatures_HMAC_Personalized_Signature_Data {
    get {
  ...
  public var aesGcmResponseData: Signatures_AES_GCM_Response_Signature_Data {
    get {
  ...
  public enum OneOf_SigType: Equatable, Sendable {
...
public struct Signatures_GetSessionInfoRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var keyIdentity: Signatures_KeyIdentity {
    get {_keyIdentity ?? Signatures_KeyIdentity()}
    set {_keyIdentity = newValue}
  }
  /// Returns true if `keyIdentity` has been explicitly set.
  public var hasKeyIdentity: Bool {self._keyIdentity != nil}
  /// Clears the value of `keyIdentity`. Subsequent reads from it will return its default value.
  public mutating func clearKeyIdentity() {self._keyIdentity = nil}
...
public struct Signatures_SessionInfo: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var clockTime: UInt32 = 0

  public var status: Signatures_Session_Info_Status = .ok
...
extension Signatures_Tag: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0TAG_SIGNATURE_TYPE\0\u{1}TAG_DOMAIN\0\u{1}TAG_PERSONALIZATION\0\u{1}TAG_EPOCH\0\u{1}TAG_EXPIRES_AT\0\u{1}TAG_COUNTER\0\u{1}TAG_CHALLENGE\0\u{1}TAG_FLAGS\0\u{1}TAG_REQUEST_HASH\0\u{1}TAG_FAULT\0\u{2}v\u{3}TAG_END\0")
}

extension Signatures_SignatureType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SIGNATURE_TYPE_AES_GCM\0\u{2}\u{5}SIGNATURE_TYPE_AES_GCM_PERSONALIZED\0\u{1}SIGNATURE_TYPE_HMAC\0\u{2}\u{2}SIGNATURE_TYPE_HMAC_PERSONALIZED\0\u{1}SIGNATURE_TYPE_AES_GCM_RESPONSE\0")
}

extension Signatures_Session_Info_Status: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SESSION_INFO_STATUS_OK\0\u{1}SESSION_INFO_STATUS_KEY_NOT_ON_WHITELIST\0")
}
...
extension Signatures_KeyIdentity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".KeyIdentity"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}public_key\0\u{2}\u{2}handle\0\u{c}\u{2}\u{1}")
  ...
  public static func ==(lhs: Signatures_KeyIdentity, rhs: Signatures_KeyIdentity) -> Bool {
...
extension Signatures_AES_GCM_Personalized_Signature_Data: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AES_GCM_Personalized_Signature_Data"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}epoch\0\u{1}nonce\0\u{1}counter\0\u{3}expires_at\0\u{1}tag\0")
  ...
  public static func ==(lhs: Signatures_AES_GCM_Personalized_Signature_Data, rhs: Signatures_AES_GCM_Personalized_Signature_Data) -> Bool {
...
extension Signatures_AES_GCM_Response_Signature_Data: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".AES_GCM_Response_Signature_Data"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}nonce\0\u{1}counter\0\u{1}tag\0")
  ...
  public static func ==(lhs: Signatures_AES_GCM_Response_Signature_Data, rhs: Signatures_AES_GCM_Response_Signature_Data) -> Bool {
    if lhs.nonce != rhs.nonce {return false}
    if lhs.counter != rhs.counter {return false}
    if lhs.tag != rhs.tag {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
extension Signatures_HMAC_Signature_Data: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HMAC_Signature_Data"
  ...
  public static func ==(lhs: Signatures_HMAC_Signature_Data, rhs: Signatures_HMAC_Signature_Data) -> Bool {
    if lhs.tag != rhs.tag {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Signatures_HMAC_Personalized_Signature_Data: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".HMAC_Personalized_Signature_Data"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}epoch\0\u{1}counter\0\u{3}expires_at\0\u{1}tag\0")
  ...
  public static func ==(lhs: Signatures_HMAC_Personalized_Signature_Data, rhs: Signatures_HMAC_Personalized_Signature_Data) -> Bool {
    if lhs.epoch != rhs.epoch {return false}
    if lhs.counter != rhs.counter {return false}
    if lhs.expiresAt != rhs.expiresAt {return false}
    if lhs.tag != rhs.tag {return false}
...
extension Signatures_SignatureData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".SignatureData"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}signer_identity\0\u{4}\u{4}AES_GCM_Personalized_data\0\u{3}session_info_tag\0\u{4}\u{2}HMAC_Personalized_data\0\u{3}AES_GCM_Response_data\0\u{c}\u{7}\u{1}")
  ...
  public static func ==(lhs: Signatures_SignatureData, rhs: Signatures_SignatureData) -> Bool {
...
extension Signatures_GetSessionInfoRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".GetSessionInfoRequest"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}key_identity\0")
  ...
  public static func ==(lhs: Signatures_GetSessionInfoRequest, rhs: Signatures_GetSessionInfoRequest) -> Bool {
...
extension Signatures_SessionInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}counter\0\u{1}publicKey\0\u{1}epoch\0\u{3}clock_time\0\u{1}status\0\u{1}handle\0")
  ...
  public static func ==(lhs: Signatures_SessionInfo, rhs: Signatures_SessionInfo) -> Bool {
    if lhs.counter != rhs.counter {return false}
